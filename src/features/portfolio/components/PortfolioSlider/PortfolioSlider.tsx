...
import SlideImage from "./PortfolioSlideImage";
import SlideText, { SlideTextInterface } from "./PortfolioSlideText";
import { analyticsEvent } from "../../../analytics/services/analytics.service";
